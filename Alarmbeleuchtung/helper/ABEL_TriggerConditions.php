 ...
 * @file          ABEL_TriggerConditions.php
    ...
    public function GetActualVariableStates(): void
    {
        ...
        foreach ($variables as $variable) {
            ...
            if ($conditions && isset($sensorID)) {
                ...
                $actionName = 'Aus';
                if ($variable['AlarmLightAction'] == 1) {
                    $actionName = 'An';
                }
                if ($variable['AlarmLightAction'] == 2) {
                ...
                $actualVariableStates[] = ['ActualStatus' => $stateName, 'SensorID' => $sensorID, 'Designation' =>  $variable['Designation'], 'AlarmLightAction' =>  $actionName, 'LastUpdate' => $lastUpdate];
            }
        }
                    ...
                    if (array_key_exists(0, $primaryCondition[0]['rules']['variable'])) {
                        ...
                        if ($SenderID == $id) {
                            ...
                            if (!$execute) {
                                ...
                                //Alarm light
                                switch ($variable['AlarmLightAction']) {
                                    case 0:
